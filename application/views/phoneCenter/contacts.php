...
<div id="container">
    ...
    <ul id="contactList" class="small-block-grid-6 columns contacts">
        ...
        <li><a href="<?php echo base_url()."index.php/phone/contactSearch";?>"><img class="navPic" src="<?php echo base_url().'images/adduser_icon.png';?>"><h2 class="contactName">search</h2></a></li>
